...
value using the resample function. After that make a histogram of the
data and describe what you see.*
...
true variance of the mean was unknown, it must be approximated by the
